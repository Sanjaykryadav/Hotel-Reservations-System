...
void intro()
 {
   printf("\n\t             Near sarowar Chowk, NH132 Road, Halishar City,\n\t\t\t\t Nadia 141235, INDIA");
   printf("\n\n                              Ph. No.:011-27223959");
   printf("\n\n\n                             WELCOMES YOU..............");
   printf("\n\n\n\t Royal Bengal Dhaba is one of the newest Hotel in Halishar. The Hotel is \t\tequipped with with all the general amenities and facilities that go \t\talong with memorable stay. Set amidst beautifully landscaped gardens, \t\tit proves to be a ideal dream destination for perceptive traveller.");
